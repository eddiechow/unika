...
namespace BackendForCompany.WebMasterForm
{
    public partial class MainForm : MetroForm
    {
        ...
        private string[][] menuList = {
            ...
            new string[] { "loginLogIcon", "loginLogLabel", "LoginLogUserCtrl" },
            new string[] { "staffManagementIcon", "staffManagementLabel", "StaffManagmentUserCtrl" },
            new string[] { "supplierManagementIcon", "supplierManagementLabel", "SupplierManagementUserCtrl" },
