...
namespace BackendForCompany.StaffForm
{
    public partial class MainForm : MetroForm
    {
        ...
        private string[][] menuList = {
            ...
            new string[] { "approveRejectOrderIcon", "approveRejectOrderLabel", "ApproveRejectOrderUserCtrl" },
            new string[] { "reportProblemIcon", "reportProblemLabel", "ReportProblemUserCtrl" },
